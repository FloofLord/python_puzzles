...
#         outer_r = a[i-1]
#         outer_l = a[i+8]
#         #print(outer_l,outer_r)
#         if  outer_l not in ascii_lowercase or outer_r not in ascii_lowercase:
#             continue
#     except:
#         continue
...
#     if not check(left,ascii_uppercase):
#         continue
#        # f.append(left)
#     if not check(right, ascii_uppercase):
#         continue
#         #f.append(right)        
#     if check(middle,ascii_lowercase):
#         f.append(middle)
#         print(outer_r ,left, middle,right,  outer_l)

    
# print("".join(f))
import re

d = re.findall(r"[a-z][A-Z]{3}[a-z][A-Z]{3}[a-z]",a)
print(d)
